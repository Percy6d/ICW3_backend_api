...
const username = 'Percy6d'
const password = 'josh1998'
const dbName = 'LessonHub'
let db = null

// Connect to MongoDB database
async function main () {
  const client = new MongoClient(`mongodb+srv://${username}:${password}@cluster0.jgsse7p.mongodb.net/test`)
  try {
...
// Update number of available spaces in lesson
